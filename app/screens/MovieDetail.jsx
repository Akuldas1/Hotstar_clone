    ...
    <ScrollView style={styles.container}>
      <View style={{ flexDirection: 'column', gap: 5 }}>
        ...
        <Text className="text-gray-400" style={{ fontFamily: 'Inter-Bold', alignSelf: 'center' }}>
          2024 <Entypo name="dot-single" size={16} color="gray" /> 2h 36m <Entypo name="dot-single" size={16} color="gray" /> English <Entypo name="dot-single" size={16} color="gray" /> U/A 16+
        </Text>
        ...
        <Text className="text-gray-500">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique nam ipsum, magnam, maiores esse voluptatum obcaecati velit voluptate nemo magni aliquid ratione sint iure possimus impedit deleniti! Rerum, quae iste.
        </Text>
      </View>
      ...
      <View className="mt-5">
        <Text className="text-white" style={{ fontFamily: 'Inter-Bold', fontSize: 20, paddingLeft: 10 }}>
          More Like This
        </Text>
        <Movies />
      </View>
